    ...
    public void dibujarTableroPublico(Tablero t) {
        ...
        for (int r = 0; r < n; r++) {
            ...
            for (int c = 0; c < n; c++) {
                ...
                char ch;
                if (!celda.estaDisparada()) ch = '.';
                else ch = celda.tieneBarco() ? 'X' : 'O';
                print(ch + " ");
            }
            println("");
        }
    ...
    public void dibujarTableroOculto(Tablero t) {
        ...
        for (int r = 0; r < n; r++) {
            ...
            for (int c = 0; c < n; c++) {
                Celda celda = t.getCelda(r, c);
                char ch;
                if (celda.tieneBarco() && celda.estaDisparada()) ch = 'X';
                else if (celda.tieneBarco()) ch = 'S';
                else if (celda.estaDisparada()) ch = 'O';
                else ch = '.';
                print(ch + " ");
            }
            println("");
